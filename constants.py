...
STREAM_PARAM_KEYS = ("temperature", "top_p", "top_k", "max_tokens", "repeat_penalty")
...
LABEL_N_CTX = "Контекст"
CONTEXT_USAGE_UNKNOWN = "Контекст: **— / %d токенов**"
CONTEXT_USAGE_TEMPLATE = "Контекст: **%d / %d токенов (%.1f%%)**"
